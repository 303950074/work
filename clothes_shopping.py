...
print("---------------------------------------------------------------------------------")
print("总金额为：￥",(253.6*10+86.3*60+96.8*43+135.9*63+65.8*63+49.3*120+86.3*72+253.6*69+86.3*35+253.6*140+86.3*90+135.9*24+65.8*45+96.8*25+86.3*60+65.8*129
                       +253.6*10+96.8*43+65.8*63+86.3*60+135.9*63+96.8*60+65.8*58+86.3*140+65.8*48+96.8*43
                       +135.9*57+253.6*10+65.8*63+96.8*78))
print("其中羽绒服占总销售额比率为%.3f%%"%((253.6*(10+69+140+10+10)/198400.6*100)))
print("其中皮草占总销售额比率为%.3f%%"%((135.9*(63+24+63+57)/198400.6*100)))
print("其中风衣占总销售额比率为%.3f%%"%(96.8*(43+25+43+60+43+78)/198400.6*100))
print("其中牛仔裤占总销售额比率为%.3f%%"%(86.3*(60+72+35+90+60+60+140)/198400.6*100))
print("其中T恤占总销售额比率为%.3f%%"%(65.8*(63+45+129+63+58+48+63)/198400.6*100))
print("其中衬衫占总销售额比率为%.3f%%"%(49.3*120/198400.6*100))
